...
export const YOUTUBE_SEARCH_SUGGESTION_API = `https://youtube.googleapis.com/youtube/v3/search?part=snippet&key=${apiKey}&regionCode=IN&type=video&maxResults=20&q=`;
